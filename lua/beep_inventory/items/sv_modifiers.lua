...
createModifier("fire", {
    Chance = {
        Common     = {min = 0.10, max = 0.20},
        Uncommon   = {min = 0.20, max = 0.35},
        Rare       = {min = 0.35, max = 0.50},
        Epic       = {min = 0.50, max = 0.65},
        Legendary  = {min = 0.65, max = 0.80},
        Celestial  = {min = 0.80, max = 0.95},
        God        = {min = 0.95, max = 1.10},
        Glitched   = {min = 1.10, max = 1.25},
        ["????????"] = {min = 1.25, max = 1.40}
    },
    Resistance = {
        Common     = {min = 0.90, max = 1.00},
        Uncommon   = {min = 0.80, max = 0.90},
        Rare       = {min = 0.70, max = 0.80},
        Epic       = {min = 0.60, max = 0.70},
        Legendary  = {min = 0.50, max = 0.60},
        Celestial  = {min = 0.40, max = 0.50},
        God        = {min = 0.30, max = 0.40},
        Glitched   = {min = 0.20, max = 0.30},
        ["????????"] = {min = 0.10, max = 0.20}
    },
    Length = {
        Common     = {min = 1, max = 2},
        ...
        Celestial  = {min = 6, max = 7},
        God        = {min = 7, max = 8},
        Glitched   = {min = 8, max = 9},
        ["????????"] = {min = 9, max = 10}
    }
    ...
    if math.random() < chance / resistance then
        ...
        ParticleEffect("[5]black_hole_b", receiver:GetPos(), Angle(0,0,0), nil)
    end
end)
...
createModifier("freeze", {
    ...
    if math.random() < chance / resistance then
        ...
        ParticleEffect("ice_blast", receiver:GetPos(), Angle(0,0,0), nil)
        timer.Simple(length, function() if IsValid(receiver) then receiver:Freeze(false) end end)
    end
end)
...
createModifier("poison", {
    Chance = {
        ...
        Uncommon   = {min = 0.10, max = 0.20},
        Rare       = {min = 0.20, max = 0.35},
        Epic       = {min = 0.35, max = 0.50},
        Legendary  = {min = 0.50, max = 0.65},
        Celestial  = {min = 0.65, max = 0.80},
        God        = {min = 0.80, max = 0.95},
        Glitched   = {min = 0.95, max = 1.10},
        ["????????"] = {min = 1.10, max = 1.25}
    },
    Resistance = {
        Common     = {min = 0.90, max = 1.00},
    ...
    Damage = {
        ...
        Celestial  = {min = 9, max = 12},
        God        = {min = 12, max = 15},
        Glitched   = {min = 15, max = 18},
        ["????????"] = {min = 18, max = 22}
    },
    Duration = {
        Common     = {min = 1, max = 2},
        ...
        Celestial  = {min = 7, max = 8},
        God        = {min = 8, max = 9},
        Glitched   = {min = 9, max = 10},
        ["????????"] = {min = 10, max = 12}
    }
        ...
        for i = 1, duration do
            timer.Simple(i, function()
                if IsValid(receiver) then
                    ...
                    ParticleEffect("poison_smoke", receiver:GetPos(), Angle(0,0,0), nil)
                end
            end)
        end
    end
...
createModifier("electrocute", {
    Chance = {
        Common     = {min = 0.05, max = 0.15},
        Uncommon   = {min = 0.15, max = 0.30},
    ...
    if math.random() < chance / resistance then
        receiver:Freeze(true)
        ParticleEffect("stunstick_spark", receiver:GetPos(), Angle(0,0,0), nil)
        timer.Simple(duration, function() if IsValid(receiver) then receiver:Freeze(false) end end)
    end
end)
...
createModifier("doubletap", {
    Chance = {
        ...
        Epic       = {min = 0.30, max = 0.40},
        Legendary  = {min = 0.40, max = 0.50},
        Celestial  = {min = 0.50, max = 0.60},
        God        = {min = 0.60, max = 0.70},
        Glitched   = {min = 0.70, max = 0.80},
        ["????????"] = {min = 0.80, max = 0.90}
    }
}, "Gives a chance to fire an extra shot.", function(attacker, _, item)
    local chance = item:GetProperty("Chance") or math.random()
    if math.random() < chance then return 2 end
    return 1
end)
...
createModifier("explosive", {
    ...
    Radius = {
        ...
        Uncommon   = {min = 150, max = 180},
        Rare       = {min = 180, max = 210},
        Epic       = {min = 210, max = 240},
        Legendary  = {min = 240, max = 270},
        Celestial  = {min = 270, max = 300},
        God        = {min = 300, max = 330},
        Glitched   = {min = 330, max = 360},
        ["????????"] = {min = 360, max = 400}
    },
    Damage = {
        ...
        Rare       = {min = 35, max = 50},
        Epic       = {min = 50, max = 65},
        Legendary  = {min = 65, max = 80},
        Celestial  = {min = 80, max = 95},
        God        = {min = 95, max = 110},
        Glitched   = {min = 110, max = 130},
        ["????????"] = {min = 130, max = 150}
    }
}, "Causes an explosion on hit, dealing area damage.", function(attacker, receiver, item)
    local chance = item:GetProperty("Chance") or math.random()
    local radius = item:GetProperty("Radius") or 150
    local damage = item:GetProperty("Damage") or 20
    if math.random() < chance then
        util.BlastDamage(attacker, attacker, receiver:GetPos(), radius, damage)
        ParticleEffect("explosion_huge", receiver:GetPos(), Angle(0,0,0), nil)
    end
end)
...
createModifier("lifesteal", {
    ...
    HealPercent = {
        Common     = {min = 0.05, max = 0.10},
        Uncommon   = {min = 0.10, max = 0.15},
        Rare       = {min = 0.15, max = 0.20},
        Epic       = {min = 0.20, max = 0.25},
        Legendary  = {min = 0.25, max = 0.30},
        Celestial  = {min = 0.30, max = 0.35},
        God        = {min = 0.35, max = 0.40},
        Glitched   = {min = 0.40, max = 0.45},
        ["????????"] = {min = 0.45, max = 0.50}
    }
    ...
    if math.random() < chance then
        attacker:SetHealth(math.min(attacker:Health() + math.ceil(receiver:Health() * heal), attacker:GetMaxHealth()))
        ParticleEffect("health_vial_glow", attacker:GetPos(), Angle(0,0,0), nil)
    end
end)
...
createModifier("damage", {
    ...
    local statData = BCORE.Inventory.Modifiers["damage"].stats.Damage[rarity]
    if statData then
        local scale = 1000
        weapon:SetProperty("Damage", math.ceil(math.random(math.floor(statData.min*scale), math.floor(statData.max*scale))/scale))
    end
end)

createModifier("accuracy", {
    Accuracy = {
        Common     = { min = 1.00, max = 1.05 },
        Uncommon   = { min = 1.05, max = 1.10 },
        Rare       = { min = 1.10, max = 1.15 },
        Epic       = { min = 1.15, max = 1.20 },
        Legendary  = { min = 1.20, max = 1.25 },
        Celestial  = { min = 1.30, max = 1.40 },
        God        = { min = 1.40, max = 1.50 },
        Glitched   = { min = 1.50, max = 1.60 },
        ["????????"] = { min = 1.50, max = 1.60 }
    }
}, "Increases weapon accuracy.", nil, function(item, weapon)
    local rarity = item.rarity
    local statData = BCORE.Inventory.Modifiers["accuracy"].stats.Accuracy[rarity]
    if statData then
        local scale = 1000
        weapon:SetProperty("Spread", math.ceil(math.random(math.floor(statData.min*scale), math.floor(statData.max*scale))/scale*100)/100)
    end
end)
...
createModifier("recoil", {
    Recoil = {
        Common     = { min = 0.95, max = 1.00 },
        Uncommon   = { min = 0.90, max = 0.95 },
        Rare       = { min = 0.85, max = 0.90 },
        Epic       = { min = 0.80, max = 0.85 },
        Legendary  = { min = 0.75, max = 0.80 },
        Celestial  = { min = 0.70, max = 0.75 },
        God        = { min = 0.65, max = 0.70 },
        Glitched   = { min = 0.60, max = 0.65 },
        ["????????"] = { min = 0.60, max = 0.65 }
    }
}, "Reduces weapon recoil.", nil, function(item, weapon)
    local rarity = item.rarity
    local statData = BCORE.Inventory.Modifiers["recoil"].stats.Recoil[rarity]
    if statData then
        local scale = 1000
        weapon:SetProperty("Recoil", math.ceil(math.random(math.floor(statData.min*scale), math.floor(statData.max*scale))/scale*100)/100)
    end
end)
...
createModifier("infinite", {
    ...
    local rarity = item.rarity
    local statData = BCORE.Inventory.Modifiers["infinite"].stats.ClipSize[rarity]
    if statData then
        local scale = 1000
        weapon:SetProperty("ClipSize", math.ceil(math.random(math.floor(statData.min*scale), math.floor(statData.max*scale))/scale))
    end
end)
...
createModifier("void", {
    ...
    Radius = {
        ...
        Rare       = {min = 200, max = 250},
        Epic       = {min = 250, max = 300},
        Legendary  = {min = 300, max = 350},
        Celestial  = {min = 350, max = 400},
        God        = {min = 400, max = 450},
        Glitched   = {min = 450, max = 500},
        ["????????"] = {min = 500, max = 600}
    },
    Force = {
        Common     = {min = 500, max = 700},
        Uncommon   = {min = 700, max = 900},
        Rare       = {min = 900, max = 1100},
        Epic       = {min = 1100, max = 1300},
        Legendary  = {min = 1300, max = 1500},
        Celestial  = {min = 1500, max = 1700},
        God        = {min = 1700, max = 1900},
        Glitched   = {min = 1900, max = 2100},
        ["????????"] = {min = 2100, max = 2300}
    }
    ...
    if math.random() < chance then
        ...
        for _, ent in pairs(ents.FindInSphere(pos, radius)) do
            if IsValid(ent) and ent:IsPlayer() and not ent == attacker then
                local dir = (pos - ent:GetPos()):GetNormalized()
                ent:SetVelocity(dir * force)
                ParticleEffect("portal_impact", pos, Angle(0,0,0), nil)
            end
        end
    end
end)
    ...
    if math.random() < chance then
        for i = 1, duration do
            timer.Simple(i, function()
                if IsValid(receiver) then
                    receiver:TakeDamage(damage, attacker, nil)
                    ParticleEffect("blood_impact_red", receiver:GetPos(), Angle(0,0,0), nil)
                end
            end)
        end
    end
...
createModifier("ricochet", {
    ...
    local chance = item:GetProperty("Chance") or math.random()
    if math.random() < chance then
        local nearby = ents.FindInSphere(receiver:GetPos(), 400)
        for _, ent in pairs(nearby) do
            if ent ~= receiver and ent:IsPlayer() then
                ...
                ParticleEffect("weapon_tracers", ent:GetPos(), Angle(0,0,0), nil)
                break
            end
        end
    end
...
createModifier("time_warp", {
    ...
    if math.random() < chance then
        ...
        ParticleEffect("time_freeze", receiver:GetPos(), Angle(0,0,0), nil)
        timer.Simple(duration, function() if IsValid(receiver) then receiver:SetLaggedMovementValue(1) end end)
    end
end)
...
createModifier("speed", {
    ...
    local rarity = item.rarity
    local statData = BCORE.Inventory.Modifiers["rpm"].stats.RPM[rarity]
    if statData then
        local scale = 1000
        weapon:SetProperty("RPM", math.ceil(math.random(math.floor(statData.min*scale), math.floor(statData.max*scale))/scale*100)/100)
    end
end)
...
createModifier("shadow_step", {
    ...
    if math.random() < chance then
        local newPos = receiver:GetPos() + receiver:GetForward() * distance
        receiver:SetPos(newPos)
        ParticleEffect("shadow_teleport", newPos, Angle(0,0,0), nil)
    end
end)
...
thread.Hook("BCORE.Inventory.Socket", function(ply, itemID, modifierID)
    ...
    if modData.Modify then
        ...
        for _, stat in ipairs(modData.stats) do
...
hook.Add("EntityTakeDamage", "Weapon_ApplyModifiers", function(target, dmginfo)
    ...
    if weapon.customData and weapon.customData.Modifiers then
        for _, modifier in ipairs(weapon.customData.Modifiers) do
            local modType = modifier.customData and modifier.customData.Type
            local modData = servertable[modType]
     
            if modData and modData.OnHit then
                modData.OnHit(attacker, target, modifier, dmginfo)
            end
        end
    end
end)
